...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Image img = new ImageIcon("D:\\Java Project\\Gub-Attendance-Management\\src\\main\\java\\Attendance\\gub_logo.png").getImage();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            ...
            String file = "D:\\Java Project\\Gub-Attendance-Management\\src\\main\\java\\Attendance\\users.txt";
            ...
            if (isLoginSuccess) {
                ...
                if (mode.getSelectedItem() == "Administrator") {
                    ...
                    f2.setVisible(true);
                    dispose();
                } else if (mode.getSelectedItem() == "Teacher") {
